...
import { ArrowRight, ChevronRight, Menu, X, BookOpenCheck } from 'lucide-react'
                ...
                <section>
                    <div className="relative pt-24 md:pt-36">
                        <AnimatedGroup
                            ...
                            <Image
                                src="https://placehold.co/3276x4095.png"
                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <h1 className="mt-8 max-w-4xl mx-auto text-balance text-4xl font-extrabold text-primary md:text-6xl lg:mt-16 xl:text-[5.25rem]">
                            ...
                            <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                                ...
                                <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl border p-4 shadow-lg shadow-zinc-950/15 ring-1">
                                    <Image
                                        ...
                                        src="https://placehold.co/2700x1440.png"
                                        data-ai-hint="quiz application dark"
                                        alt="app screen dark"
                                        width="2700"
                                        height="1440"
                                    />
                                    <Image
                                        ...
                                        src="https://placehold.co/2700x1440.png"
                                        data-ai-hint="quiz application light"
                    ...
                    <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
                        ...
                        <div className="bg-background group-data-[state=active]:block lg:group-data-[state=active]:flex mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border p-6 shadow-2xl shadow-zinc-300/20 md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none dark:shadow-none dark:lg:bg-transparent">
                            ...
                            <div className="flex w-full flex-col space-y-3 sm:flex-row sm:gap-3 sm:space-y-0 md:w-fit">
                                 <div className={cn('items-center gap-2 hidden lg:flex')}>
